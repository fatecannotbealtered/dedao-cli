---
name: Bug Report
about: Report a bug in dedao-cli
title: "[Bug] "
labels: bug
assignees: ''
---
...
- **dedao-cli version**: (run `dedao-cli --version`)
...
<details>
<summary><code>dedao-cli doctor</code> output</summary>

```
(paste the output of `dedao-cli doctor` here)
```
